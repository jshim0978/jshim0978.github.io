  ...
  return (
    <section className="py-12 bg-background-strong min-h-[80vh]">
      <div className="max-w-5xl mx-auto px-4">
        <h1 className="text-3xl font-bold text-center mb-10 font-heading text-primary drop-shadow-lg">🚀 Projects</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          {projects.map(project => (
            <button
              ...
              type="button"
            >
              <h3 className="text-lg font-semibold mb-2 font-heading group-hover:text-primary transition-colors">{project.title}</h3>
            </button>
          ))}
        </div>
      </div>
