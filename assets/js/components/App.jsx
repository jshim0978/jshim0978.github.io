...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {showBackToTop && (
        <button
          className="fixed bottom-8 right-8 w-12 h-12 bg-blue-600 text-black rounded-full shadow-lg flex items-center justify-center text-2xl transition hover:bg-blue-800 z-50"
          onClick={scrollToTop}
